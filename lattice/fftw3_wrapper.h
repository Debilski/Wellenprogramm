...
public:
    ...
    static fftw_plan blitzFftwPlan_dft_c2c_forward_2d(blitz::Array< std::complex< double >, 2 >& in, blitz::Array<
        std::complex< double >, 2 >& out);
    static fftw_plan blitzFftwPlan_dft_c2c_backward_2d(blitz::Array< std::complex< double >, 2 >& in, blitz::Array<
        std::complex< double >, 2 >& out);
...
bool FastFTPlan::check(FftType type, std::complex< double >* complex_in,
                       ...
                       int sizeIn, int sizeOut, int dimensions) const
{
    return fftType_ == type && complex_in_ == complex_in && complex_out_ == complex_out && real_in_
        == real_in && real_out_ == real_out && size_in_ == sizeIn && size_out_ == sizeOut
