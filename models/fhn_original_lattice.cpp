...
FhnOriginalLattice::FhnOriginalLattice(int sizeX, int sizeY, int latticeSizeX, int latticeSizeY) :
    SIIP_LatticeIntegrator< FhnOriginalLattice > ( sizeX, sizeY, latticeSizeX, latticeSizeY ),  a_0( 0, "a_0", 0., 5.0 ), a_1( 2., "a_1", 0., 20., 5 ), epsilon( 2., "epsilon", 0., 20., 5 )
{
