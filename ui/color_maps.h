...
public:
     ...
     */
    enum Mode {
        FixedColors, ScaledColors
    };

    LinearTransparentColorMap(QwtColorMap::Format = QwtColorMap::RGB);
    LinearTransparentColorMap(const QColor &from, const QColor &to, QwtColorMap::Format =
        QwtColorMap::RGB);
...
public:
    enum ColorMapTypes {
        standardColorMap, greyColorMap, jetColorMap, halfJetColorMap, autumnColorMap, hotColorMap
    };
        ...
        switch (colorMapType) {
            ...
            case hotColorMap: {
                ...
                hotColours << QColor( 11, 0, 0 ) << QColor( 21, 0, 0 ) << QColor( 32, 0, 0 )
                    ...
                    74, 0, 0 ) << QColor( 85, 0, 0 ) << QColor( 96, 0, 0 ) << QColor( 106, 0, 0 )
                    << QColor( 117, 0, 0 ) << QColor( 128, 0, 0 ) << QColor( 138, 0, 0 ) << QColor(
                    149, 0, 0 ) << QColor( 159, 0, 0 ) << QColor( 170, 0, 0 ) << QColor( 181, 0, 0 )
                    << QColor( 191, 0, 0 ) << QColor( 202, 0, 0 ) << QColor( 213, 0, 0 ) << QColor(
                    223, 0, 0 ) << QColor( 234, 0, 0 ) << QColor( 244, 0, 0 ) << QColor( 255, 0, 0 )
