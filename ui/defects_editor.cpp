...
DefectsModel::DefectsModel(const QList< Defect< GeneralComponentSystem > > &defects, const QMap<
    int, QString >& boundaryConditionsIdentifier, QObject *parent) :
  QAbstractTableModel( parent ), defectsList( defects ), boundaryConditionsIdentifier(
      boundaryConditionsIdentifier )
{
}
...
TextSelectionDelegate::TextSelectionDelegate(
    const QMap< int, QString >& boundaryConditionsIdentifier, QObject* parent) :
  QItemDelegate( parent ), boundaryConditionsIdentifier( boundaryConditionsIdentifier )
{
}
