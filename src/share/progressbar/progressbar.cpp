...
ProgressBar::ProgressBar(long long max) : max(max),
                                          percentage(0),
                                          ndots("                         "),
...
ProgressBar::ProgressBar(long long max, const std::string& infostring) : max(max),
                                                                         percentage(0),
                                                                         ndots("                         "),
...
void ProgressBar::p_print(long long status, const std::string& additional)
{
    ...
    std::cout << infostring << ": [" << ndots << "] " << percentage << "%" << additional << "\r" << std::flush;
    if (percentage == 100)
        std::cout << "\n" << std::flush;
}
