...
template<> struct Metainfo< FhnAdditionalLattice >::NoiseMapping< secondComponent > {
    enum {
...
public:
    ...
    inline FhnAdditionalLattice(int sizeX, int sizeY, int latticeSizeX, int latticeSizeY) :
        SIIP_LatticeIntegrator< FhnAdditionalLattice > ( sizeX, sizeY, latticeSizeX, latticeSizeY )
        //, lambda(2, "lambda"), k3(8.5, "k3"), k1(-6.92, "k1", -100, 100), tau(48, "tau"), theta(1, "theta")
,alph(1.0, "alpha"), eps(0.1, "epsilon"), thet(0.01, "theta"), gamm(0.1, "gamma")
    {
