...
{
public:
    inline OregonatorLattice(int sizeX, int sizeY, int latticeSizeX, int latticeSizeY) : SIIP_LatticeIntegrator<OregonatorLattice>(sizeX, sizeY, latticeSizeX, latticeSizeY),
                                                                                         epsilon(0.1, "epsilon", 0.0, 100.0),
                                                                                         epsilon_prime(0.1, "epsilon'", 0.0, 100.0),
                                                                                         q(
                                                                                             0.1, "q", 0.0, 100.0),
                                                                                         f(0.1, "f", 0.0, 100.0)
    {
