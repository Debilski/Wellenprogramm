...
template<> struct Metainfo< FhnKLattice_laplace_extended >::NoiseMapping< secondComponent > {
    enum {
        value = firstComponent
    };
};
...
template<> struct Metainfo< FhnKLattice_layers >::NoiseMapping< secondComponent > {
    enum {
        value = firstComponent
    };
};
