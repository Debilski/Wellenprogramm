...
public:
    ...
    inline PiecewiseLinearLattice(int sizeX, int sizeY, int latticeSizeX, int latticeSizeY) :
        SIIP_LatticeIntegrator< PiecewiseLinearLattice > ( sizeX, sizeY, latticeSizeX, latticeSizeY ),
            epsilon( 0.1, "epsilon", 0.0, 100.0 ), delta( -0.1, "delta", -2.0, 2.0 )
    {
