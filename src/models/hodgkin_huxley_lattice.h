...
template <> struct Metainfo< HodgkinHuxleyLattice >::NoiseMapping<0> {enum {value=0};};
...
public:
    inline HodgkinHuxleyLattice(int sizeX, int sizeY, int latticeSizeX, int latticeSizeY) :
        SIIP_LatticeIntegrator< HodgkinHuxleyLattice > ( sizeX, sizeY, latticeSizeX, latticeSizeY ),
            E_Na( 115, "E_Na", 80, 150, 1 ), E_K( -12, "E_K", -20, -1, 1 ), E_L(
                10.6, "E_L", 8, 15, 1 ), g_Na( 120, "g_Na", 80, 150, 1 ),
            g_K( 36, "g_K", 20, 50, 1 ), g_L( 0.3, "g_L", 0, 1, 2 ), C( 1.0, "C", 0.01, 10, 2 ),
