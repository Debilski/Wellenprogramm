...
BrusselatorLattice::BrusselatorLattice(int sizeX, int sizeY, int latticeSizeX, int latticeSizeY) :
    SIIP_LatticeIntegrator< BrusselatorLattice > ( sizeX, sizeY, latticeSizeX, latticeSizeY ),  a( 2, "a", 0., 5.0 ), b( 2., "b", 0., 20., 5 )
{
