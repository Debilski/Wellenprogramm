 ...
 */
Plugin::Plugin(const Plugin& Other) : libHandle_(Other.libHandle_), pfnGetEngineVersion_(Other.pfnGetEngineVersion_), pfnRegisterPlugin_(Other.pfnRegisterPlugin_), libRefCount_(Other.libRefCount_)
{
