...
ClusterCounter::ClusterCounter(const LatticeInterface* lattice) : lattice_(lattice), nextClusterId_(0), numClusters_(0), distanceThreshold_(20), sizeThreshold_(4.0), clusterThreshold_(0)
{
}
...
void ClusterCounter::countClusters()
{
    ...
    clusterPositions.erase(std::remove(
                               clusterPositions.begin(), clusterPositions.end(), nullPosition),
        clusterPositions.end());
